...
local Window = Fluent:CreateWindow({Title="  VHUB SUPER BETA",SubTitle="by ketsu",TabWidth=160,Size=UDim2.fromOffset(500, 300),Acrylic=false,Theme="DarkPurple",MinimizeKey=Enum.KeyCode.LeftControl});
...
Tabs.Home:AddButton({Title="Our Discord",Description="Click this button to copy the Discord link.",Callback=function()
	setclipboard("https://discord.gg/G2bPCeTbTr");
	Fluent:Notify({Title="vhub",Content="Link has been copied to clipboard.",Duration=3});
end});
